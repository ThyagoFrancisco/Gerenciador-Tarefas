"""
Django settings for meutarefas project.
...
SECRET_KEY = 'django-insecure-zd4+wm_a*a+g!@3f61ym+*s&tr19!$ypjm6-s!ddgcbj&4pu0$'
...
WSGI_APPLICATION = 'meutarefas.wsgi.application'
